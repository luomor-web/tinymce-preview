...
(function () {
  ...
  if (typeof tinymce !== 'undefined') {
    tinymce.PluginManager.add(PLUGIN_NAME, function (editor, url) {
      ...
      editor.addCommand('mceMultiPreview', function () {
        const controller = new PreviewController(editor, pluginOptions);
        controller.open();
      });
      ...
      return {
        getMetadata: () => ({
          ...
          url: 'https://github.com/your-org/tinymce-preview-plugin',
        }),
      };
    });
  }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = { PreviewController, DEVICES, getFullHtml };
  } else if (typeof window !== 'undefined') {
    window.TinyMCEPreviewPlugin = { PreviewController, DEVICES, getFullHtml };
  }
})();
